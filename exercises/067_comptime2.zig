...
pub fn main() void {
    ...
    count += 1;
    comptime var a1: [count]u8 = .{'A'} ** count;

    count += 1;
    comptime var a2: [count]u8 = .{'B'} ** count;

    count += 1;
    comptime var a3: [count]u8 = .{'C'} ** count;
    @compileLog("Count at compile time: ", @TypeOf(count));

    count += 1;
    comptime var a4: [count]u8 = .{'D'} ** count;
